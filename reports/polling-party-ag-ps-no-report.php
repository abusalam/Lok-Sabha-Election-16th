...
<div align="center">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td align="center">
        ...
        <thead>
        	<tr>
            	<th align='center' colspan='3' class="text-large">Uluberia Municipality Election 2015</th>
            </tr>
            <tr>
            	<td align="left" colspan="2" width="25%"><strong>DC/RC Venue :</strong></td>
                <td align="left"><strong>Uluberia High School, New Building ( Old B.T. College ) Uluberia</strong></td>
            </tr>
            <tr class="text-mid">
            	<td align="center">Party No</td>
                <td align="center">P.S. No.</td>
                <td align="left">Ward No. Polling Station Name</td>
            </tr>
         </thead>
            <?php
