...
<title>Master Roll - Reserve</title>
<style type="text/css">
...
<table width="750px" cellpadding="0" cellspacing="0" border="0">
	<tr><td align="center">
	<table width="100%">
		<tr><td align="center" colspan="2" class="heading2">MASTER ROLL (RESERVE)</td></tr>
...
?>			<tr><td width="10%" class="table2">Polling Party : <?php print $grp_id; ?></td>
				...
				<table width="100%">
					<tr><td class="table" width="5%">&nbsp;<?php print $rec_arr['poststat']; ?></td>
						<td class="table" width="65%">&nbsp;<?php print $rec_arr['officer_name'].", ".$rec_arr['off_desg'].", (".$rec_arr['personcd'].") <br />
						...
						<td class="table" width="30%" valign="top">Received Rs. <?php print $amount; ?><hr /></td>
					</tr>
                  </table>
				</td>
			</tr>
