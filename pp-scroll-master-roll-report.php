...
<title>PP Scroll Report/ Master Roll Report</title>
<?php
...
if($submit=="Submit")
{
	...
	?>
    <script>
		window.open("reports/master-roll.php?assembly=<?php echo $assembly; ?>");
	</script>
    <?php
	}
	else
	...
	?>
	<script>
		window.open("reports/pp-scroll.php?assembly=<?php echo $assembly; ?>");
	</script>
	<?php
	}
}
