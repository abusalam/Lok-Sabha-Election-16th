...
if($sub=="Randomise")
{
	...
	if($_REQUEST['txt1']=="admin" && $_POST['hid_rand']==(isset($_SESSION['hid_rand3'])?$_SESSION['hid_rand3']:$_POST['hid_rand']))
	{ ?>
...
function randomise_click()
{
	...
	xmlhttp.open("GET","randomise3.php?pc_cd="+pc+"&dist=<?php print $dist_cd; ?>",true);
	...
	<?php }
	$_SESSION['hid_rand3']=$_POST['hid_rand'];
}
?>
...
<tr>
  <td align="center">THIRD RANDOMISATION</td></tr>
