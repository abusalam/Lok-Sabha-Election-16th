...
function new_per_search()
{
	...
	xmlhttp.open("GET","ajax-replacement.php?for_subdiv="+for_subdiv+"&forpc="+forpc+"&assembly="+forassembly+"&posting_status="+posting_status+"&groupid="+groupid+"&gender="+gender+"&draft_subdiv="+draft_subdiv+"&opn=g_new_per",true);
	xmlhttp.send();
}
