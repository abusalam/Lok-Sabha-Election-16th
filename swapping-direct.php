...
function fatch_office_agsubdiv(str)
{
	...
	document.getElementById('forsubdivision_name').innerHTML="";
	document.getElementById('forsubdivision').value="";
	document.getElementById('forpc_name').innerHTML="";
	document.getElementById('forpc').value="";
	document.getElementById('poststat_details').innerHTML="";
	if(Subdivision.selectedIndex>0)
	{
		document.getElementById('forsubdivision_name').innerHTML=Subdivision.options[Subdivision.selectedIndex].text;
		document.getElementById('forsubdivision').value=document.getElementById('Subdivision').value;
	}
...
function pc_change(str)
{
	...
	{
		document.getElementById('forpc_name').innerHTML=pc.options[pc.selectedIndex].text;
		document.getElementById('forpc').value=document.getElementById('pc').value;
	}
...
<tr><td align="center"><form method="post" name="form1" id="form1" enctype="multipart/form-data">
  <table width="95%" class="form" cellpadding="0">
    ...
    <td align="left"><input type="checkbox" id="chksetsubdivision" name="chksetsubdivision" onclick="return chksetsubdivision_change();" />
      ...
      <td align="left" valign="top"><select name="Subdivision" id="Subdivision" style="width:170px;" disabled="disabled" onchange="fatch_office_agsubdiv(this.value)">
      ...
      <td align="left" valign="top" style="width:170px;"><label id="forsubdivision_name" name="forsubdivision_name"></label>
      <input type="hidden" id="forsubdivision" name="forsubdivision" /></td>
    </tr>
    <tr>
    <td align="left">&nbsp;</td>
    ...
    <td align="left" valign="top" id="pc_result"><select name="pc" id="pc" style="width:170px;" disabled="disabled" onchange="return pc_change(this.value);"></select></td>
      ...
      <td align="left" valign="top"><label id="forpc_name" name="forpc_name"></label>
      <input type="hidden" id="forpc" name="forpc" /></td>
    </tr>
    <tr><td class="text_small" align="right">Total Member&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="left" id="poststat_details" colspan="4" class="text_small"></td></tr>
    <tr>
