...
function Subdivision_change(str)
{
	...
	xmlhttp.open("GET","ajax-first-app3.php?Subdivision="+str+"&opn=gen_sl_draft",true);
...
if($submit=="PDF")
{
	...
	?>
    <script>
		window.open("fpdf/training-app-letter3-draft.php?Subdivision=<?php echo $subdiv; ?>&txtfrom=<?php echo $txtfrom; ?>&txtto=<?php echo $txtto;?>&hid_rec=<?php echo $hid_rec;?>");
	</script>
    <?php
}
if($submit=="EXCEL")
{
	...
	?>
    <script>
		window.open("ajax/first_app3_excel_draft.php?subdiv=<?php echo $subdiv; ?>&txtfrom=<?php echo $txtfrom; ?>&txtto=<?php echo $txtto;?>&hid_rec=<?php echo $hid_rec;?>");
	</script>
    <?php
}
?>
...
<tr><td align="center"><form method="post" name="form1" id="form1" action="">
	...
	<tr>
	  <td align="left"><span class="error">*</span>PP Subdivision</td>
