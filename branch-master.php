...
function validate()
{
	...
	if($.trim(ifsc)=="")
	{
		document.getElementById("msg").innerHTML="Enter IFS Code";
...
<tr><td align="center" valign="top"><form method="post" name="form1" id="form1">
  <table width="65%" class="form" cellpadding="0">
    ...
    <tr>
      ...
      <td align="left"><span class="error">*</span>Branch IFS Code</td>
      <td align="left"><input type="text" name="ifsc" id="ifsc" style="width:82px;" maxlength="20"/></td>
    </tr>
    <tr>
      <td align="left"><span class="error">*</span>Branch Name</td>
      <td align="left" colspan="3"><input type="text" name="branch_name" id="branch_name" style="width:192px;" maxlength="20" /></td>
    </tr>
    <tr>
      <td align="left"><span class="error">&nbsp;&nbsp;</span>Branch Address</td>
      <td align="left" colspan="3"><input type="text" name="branch_address" id="branch_address" style="width:360px;" maxlength="50"/></td>
      <input type="hidden" id="hid_branch_code" name="hid_branch_code" />
    </tr>
	<tr>
	  <td align="left" colspan="4">&nbsp;</td></tr>
    <tr>
      <td colspan="4" align="center"><input type="submit" name="submit" id="submit" value="Save" class="button" onclick="javascript:return validate();" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" id="print" value="Print" class="button" onclick="javascript:return bank_print();" /></td>
    </tr>
...
<tr><td>&nbsp;</td></tr></table>
 ...
 function bank_print()
 {
		window.open("reports/branch_report.php");
 }
</script>
</html>