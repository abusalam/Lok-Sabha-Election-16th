...
<title>Employee Reverse Swapping Details</title>
<?php
...
<tr><td align="center"><form method="post" name="form1" id="form1">
  <table width="85%" class="form" cellpadding="0" style="padding-left:6px;">
    ...
    <tr>
    <td align="left" width="27%"><input type="checkbox" id="chksetsubdivision" name="chksetsubdivision" onclick="return chksetsubdivision_change();" />
        <label for="chksetsubdivision" class="text_small">Sub division wise</label></td>
    
      <td align="left" valign="top" width="30%"><span class="error">*</span>Sub Division</td>
      <td align="left" valign="top" width="21%"><select name="Subdivision" id="Subdivision" style="width:170px;display:none" disabled="disabled" onchange="return fatch_office_agsubdiv(this.value);">
