...
<title>Second Appointment Letter for Six Member Party</title>
<?php
...
if($submit=="Submit")
{
	...
	?>
    <script>
		window.open("fpdf/2nd-app-letter-6-sub-asm.php?sub=<?php echo $Subdivision; ?>&assembly=<?php echo $assembly; ?>&group_id=<?php echo $group_id; ?>&txtfrom=<?php echo $from; ?>&txtto=<?php echo $to; ?>&chksub=<?php echo $chksub;?>&chkasm=<?php echo $chkasm;?>");
	</script>
    <?php
}
?>
...
<tr><td align="center">SECOND APPOINTMENT LETTER <span class="error">(Available 6 Member)</span></td></tr>
