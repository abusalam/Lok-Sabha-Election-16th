...
if($submit=="Submit")
{
	...
	?>
    <script>
		window.open("fpdf/2nd-app-letter-6.php?sub=<?php echo $Subdivision; ?>&assembly=<?php echo $assembly; ?>&group_id=<?php echo $group_id; ?>&txtfrom=<?php echo $from; ?>&txtto=<?php echo $to; ?>");
	</script>
    <?php
}
?>
