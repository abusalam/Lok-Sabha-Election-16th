...
<title>Training Allocation From District</title>
<?php
...
function venue_capacity(str)
{
	...
	xmlhttp.open("GET","ajax-training-dist.php?venue="+str+"&opn=venuecap",true);
	xmlhttp.send();
...
function training_alloted()
{
	...
	xmlhttp.open("GET","ajax-training-dist.php?tr_type="+training_type+"&training_venue="+training_venue+"&training_dt="+training_dt+"&training_time="+training_time+"&opn=trnalloted",true);
	xmlhttp.send();
...
function area_detail(str)
{
	...
	xmlhttp.open("GET","ajax-training-dist.php?area="+str+"&dist=<?php print $dist_cd; ?>&opn=areadtl",true);
	xmlhttp.send();
}
function member_available(str)
{
	...
	xmlhttpMA.open("GET","ajax-training-dist.php?post_stat="+str+"&tr_type="+training_type+"&dist=<?php print $dist_cd; ?>&areapref="+areapref+"&area="+area+"&opn=membavl",true);
	xmlhttpMA.send();
}
...
if($action=='Submit')
{
	...
	if($area_pref=='Alloted PC')
		$for_pc=$_POST['area'];
	if($area_pref=='Assembly of Temporary Address')
		$assembly_temp=$_POST['area'];
	if($area_pref=='Assembly of Permanent Address')
		$assembly_perm=$_POST['area'];
	if($area_pref=='Assembly of Office Address')
		$assembly_off=$_POST['area'];*/
...
function training_required()
{
	...
	xmlhttp.open("GET","ajax-training-dist.php?dist=<?php print $dist_cd; ?>&opn=trnreq",true);
	xmlhttp.send();
	...
	xmlhttp1.open("GET","ajax-training-dist.php?dist=<?php print $dist_cd; ?>&opn=trnalloted_dist",true);
	xmlhttp1.send();
}
</script>
...
<table width="70%" class="form" cellpadding="0">
    ...
    <tr><td align="left" colspan="2"><b>For District [<?php echo $district; ?>] Training to be alloted:</b></td></tr>
    <tr><td align="left" colspan="2">
    	<table width="100%" id="trng_req" class="table2 demo-section" cellpadding="0" cellspacing="0" border="0"></table>
    </td></tr>
    <tr><td align="left" colspan="2"><b>For District [<?php echo $district; ?>] Training is alloted:</b></td></tr>
    <tr><td align="left" colspan="2">
    ...
    <tr>
      ...
      <td align="left"><select name="area_pref" id="area_pref" style="width:220px;" onchange="javascript:return area_detail(this.value);">
        ...
        <option value="Subdivision of PP">Subdivision of PP</option>
      </select></td></tr>
    ...
    <tr>
      ...
      <td align="left"><input type="text" name="no_pp" id="no_pp" maxlength="10" style="width:212px;" onkeypress="javascript:return wholenumbersonly(event);" /></td>
    </tr>
