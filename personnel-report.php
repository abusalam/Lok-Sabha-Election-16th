...
<tr><td align="center"><form method="post" name="form1" id="form1" action="reports/rpt1.php" target="_blank">
    ...
    <tr>
      ...
      <td align="left"><input type="text" name="officename" id="officename" style="width:122px;" onkeypress="javascript:return wholenumbersonly(event);" maxlength="8" /></td><td colspan="2">&nbsp;</td>
