...
$rsPersonnel = fatch_PersonnelList1($officeid,$personcd,$frmdt,$todt,$usercode,$p_num ,$items);
...
else
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
	  ...
	  echo "<tr><td align='right' width='3%'>$i.</td><td align='center' width='10%'>$rowPersonnel[0]</td><td width='24%' align='left'>$rowPersonnel[1]</td>";
	  echo "<td width='44%' align='left'>$rowPersonnel[2],$rowPersonnel[3]</td><td width='15%' align='left'>$rowPersonnel[4]</td>";
