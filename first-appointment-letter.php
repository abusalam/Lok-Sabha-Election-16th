...
<!--<tr><td align="center"><?php /*?><?php echo isset($_SESSION['subdiv_name'])?$_SESSION['subdiv_name']:""; ?><?php */?> SUBDIVISION</td></tr>-->
<tr>
  <td align="center">FIRST APPOINTMENT LETTER ISSUE</td></tr>
<tr><td align="center"><form method="post" name="form1" id="form1" action="fpdf/first-appointment-letter-peridwise.php" target="_blank">
    ...
    <tr><td align="left"><span class="error">*</span>Personnel ID</td>
