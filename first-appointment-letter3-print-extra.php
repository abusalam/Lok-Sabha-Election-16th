...
function excel_print(str,str1)
{
	window.open("ajax/first_app3_excel_extra.php?subdiv="+str+"&phase="+str1);
}
</script>
</head>
<?php
...
if($submit=="PDF")
{
	...
	$phase=(isset($_POST['phase'])?encode($_POST['phase']):'0');
	...
	?>
    <script>
		window.open("fpdf/training-app-letter3-extra.php?subdivision=<?php echo $subdiv; ?>&txtfrom=<?php echo $txtfrom; ?>&txtto=<?php echo $txtto;?>&hid_rec=<?php echo $hid_rec;?>&phase=<?php echo $phase;?>");
	</script>
    <?php
}
if($submit=="EXCEL")
{
	...
	?>
    <script>
		window.open("ajax/first_app3_excel_extra.php?subdiv=<?php echo $subdiv; ?>&txtfrom=<?php echo $txtfrom; ?>&txtto=<?php echo $txtto;?>&hid_rec=<?php echo $hid_rec;?>&phase=<?php echo $phase;?>");
	</script>
    <?php
}
?>
