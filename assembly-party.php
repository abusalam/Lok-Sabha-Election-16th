...
function create_row()
{
	...
	for(var j=1;j<rows;j++)
	{
		for(var k=0;k<j;k++)
		{
			var ps=document.getElementById('posting_status'+j).value;
			var psr=document.getElementById('posting_status'+k).value;
			if(ps==psr)
			{
				document.getElementById("msg").innerHTML="Duplicate Post Status Can't Entry";
				return false;
			}
		}
...
function validate()
{
	...
	{
		document.getElementById("msg").innerHTML="Member details not matching."+member.value+" no of member should be added for Reserve Polling Personnel";
		document.getElementById("member").focus();
		return false;
	}
	<?php
   ...
   <!-- <tr>
	...
	<tr>
      <td align="center" colspan="2" class="demo-section">
       ...
       <tr><td colspan="3" align="left" style="font-size: 12px;font-weight:bold;"><span class="error">*</span>For Reserve Polling Personnel</td>
      </tr> 
      <tr><td colspan="3">&nbsp;</td></tr> 
      <tr><td align="center" width="45%">Post Status</td><td align="center" width="30%">Number or Percentage</td><td align="center" width="25%">Value</td></tr></table>
