...
<tr><td align="center" valign="top"><form method="post" name="form1" id="form1">
  <table width="60%" class="form" cellpadding="0">
    ...
    <tr>
      <td colspan="3" align="center"><input type="submit" name="submit" id="submit" value="Save" class="button" onclick="javascript:return validate();" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" id="print" value="Print" class="button" onclick="javascript:return bank_print();" /></td>
    </tr>
...
<tr><td>&nbsp;</td></tr></table>
 ...
 function bank_print()
 {
		window.open("reports/bank_report.php");
 }
</script>
</html>