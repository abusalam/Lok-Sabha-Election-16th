...
<title>Assembly wise PS No & Party No</title>
<?php
...
<tr><td align="center">ASSEMBLY WISE PS No & PARTY No</td></tr>
<tr><td align="center" valign="top"><form method="post" name="form1" id="form1" action="reports/polling-party-ag-ps-no-report.php" target="_blank">
  <table width="65%" class="form" cellpadding="0">
    ...
    <tr>
      <td align="left"><span class="error">&nbsp;&nbsp;</span>Order By</td>
      <td align="left" id="assembly_result"><select name="orderby" id="orderby" style="width:200px;">
                                              <option value="party">Party</option>
                                              <option value="psno">PS No</option>
                                            </select></td>
    </tr>
	<tr>
