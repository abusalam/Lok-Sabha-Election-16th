	...
	if($num_rows>0)
	{
		...
		for($i=1;$i<=$num_rows;$i++)
		{
			...
			$poststat='"'.encode($rowReserve['poststat']).'"';
			 echo "<tr><td align='right' width='3%'>$i.</td><td align='left' width='28%'>$rowReserve[pccd]-$rowReserve[pcname]</td>\n"
			 ."<td width='28%' align='left'>$rowReserve[forassembly]-$rowReserve[assemblyname]</td>\n"
			 ."<td width='10%' align='center'>$rowReserve[poststat]</td>\n"
			 ."<td width='10%' align='center'>$rowReserve[numb] $rowReserve[no_or_pc]</td>\n";
			 echo "<td align='center' width='8%'><img src='images/edit.png' alt='' height='20px' onclick='javascript:edit_reserve($ass,$no,$poststat);' title='Click to edit' /></td>\n";
