...
//$fpc='41';
//$dist='18';
new randno1($dist,$fpc);
$asmparty=new assemblydata1($dist,$fpc);
$i=0;
...
$sobj= new mysqliconn();
 $msqli=$sobj->getconn();
 $msqli->query("update personnela set booked=' ',groupid=0,forassembly=' ' where forpc='$fpc'");
...

{
	...
	//	echo $pc . '  ' .$assembly . ' n ' .$dist . ' ';
		$ppall=new ppdata($pc,$post,$dist,$assembly,'S',2); // pp for subdivision 
