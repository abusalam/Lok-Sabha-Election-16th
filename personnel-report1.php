...
<tr><td align="center"><form method="post" name="form1" id="form1" action="fpdf/rpt12.php" target="_blank">
  ...
  <!--  <tr>
    ...
    <tr>
     ...
     <tr>
       ...
       <td colspan="4" align="center"><span class="error">*</span>Record(s)  Print
