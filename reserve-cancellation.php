...
<title>Reserve PP Cancellation</title>
<?php
...
if($action=='Submit')
{
	...
	if($ret==1)
	{
		$msg="<div class='alert-success'>Reserve Personnel Cancelled Successfully</div>";
	}
}
?>
...
<tr>
  <td align="center">RESERVE PP CANCELLATION</td></tr>
