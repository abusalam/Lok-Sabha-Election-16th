...
//$this->stmt1->bind_param('sssis',$sub,$fasm,$fpc,$gpd,$dc);
	...
	if($this->result->num_rows > 0) {
		...
		while($row = $this->result->fetch_assoc()) {
		  ...
		  $this->result1 = $this->msqli->query("select * from grp_dcrc where substr(forsubdivision,1,2)='$dist' and forsubdivision='$sub' and forassembly='$fasm' and member='$mem' and trim(dcrccd)=''  limit 0, $pdcrc  ") or die($this->msqli->error.__LINE__);
