...
<tr><td align="center">SUBDIVISION WISE POLLING PERSONNEL</td></tr>
<tr><td align="center" valign="top"><form method="post" name="form1" id="form1" action="fpdf/ofc-wise-pp-list.php" target="_blank">
