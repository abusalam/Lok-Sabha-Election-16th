...
<title>Employee Swapping Details for extra PP</title>
<?php
...
if($action=='Swapping')
{
	...
	if($forsubdivision>0)
	{
	    $rsEmp=fatch_PersonaldtlAgSubdiv_extra($subdivision,$pc,$ex_ass,$officename,$posting_status,$numberofemployee,$forsubdivision,$ex_ass1,$ex_ass2,$gender);
...
<tr><td align="center">EMPLOYEE SWAPPING DETAILS FOR EXTRA PP</td></tr>
