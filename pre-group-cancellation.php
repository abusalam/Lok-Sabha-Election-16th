      ...
      <td align="center" valign="top" class="table2 demo-section" style="height:30em; vertical-align:top">
      		<table cellpadding="0" cellspacing="0" width="80%"  >
                ...
                <tr>
                    ...
                    <td align="left" width="35%"><input type="text" name="per_id" id="per_id" style="width:152px;" onchange="return per_id_change(this.value);" onkeypress="javascript:return wholenumbersonly(event);" maxlength="9" /></td>
