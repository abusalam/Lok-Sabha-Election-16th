...
function validate()
{
	...
	if(district=="0")
	{
		document.getElementById("msg").innerHTML="Select District Name";
...
<tr>
  <td align="center">DETAILS REPORT</td></tr>
<tr><td align="center"><form method="post" name="form1" id="form1" target="_blank" action="reports/emp-query.php">
