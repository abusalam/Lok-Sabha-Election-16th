...
<table width="70%" class="form" cellpadding="0">
    ...
    <tr>
      ...
      <td align="left"><select name="area_pref" id="area_pref" style="width:220px;" onchange="javascript:return area_detail(this.value);">
        ...
        <option value="Alloted Subdivision">Alloted Subdivision</option>
        <option value="Alloted PC">Alloted PC</option>
        <option value="Assembly of Temporary Address">Assembly of Temporary Address</option>
        <option value="Assembly of Permanent Address">Assembly of Permanent Address</option>
        <option value="Assembly of Office Address">Assembly of Office Address</option>
      </select></td></tr>
