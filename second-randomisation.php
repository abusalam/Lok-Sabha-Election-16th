	  ...
	  if (xmlhttp.readyState==4 && xmlhttp.status==200)
		{
			...
			{
				document.getElementById('msg').innerHTML="Set second randomisation password.To set password <a href='set-pwd.php?rand=<?php echo encode(2);?>'>click here</a>";
				lock.disabled=true;
				randomisation.disabled=true;
				unlock.disabled=true;
				pwd.readOnly=true;
...
<tr><td align="center"><?php echo $subdiv_name; ?> SUBDIVSION</td></tr>
<tr>
