...
$rsApp=second_appointment_letter_print($sub,$assembly,$group_id,$mem_no,$from-1,$to-$from+1);
  ...
  //  $this->SetTextColor(0);
    ...
    for($i=1;$i<=rowCount($data);$i++)
	{
		...
		//	$this->SetTextColor(0,0,0);
			...
			$pr_ofc_address1="P.O. - ".$row['pr_postoffice'].", Subdiv. - ".$row['pr_subdivision'].", Dist. - ".$row['district'];
			...
			$p1_ofc_address1="P.O. - ".$row['p1_postoffice'].", Subdiv. - ".$row['p1_subdivision'].", Dist. - ".$row['district'];
			...
			$p2_ofc_address1="P.O. - ".$row['p2_postoffice'].", Subdiv. - ".$row['p2_subdivision'].", Dist. - ".$row['district'];
			...
			$p3_ofc_address1="P.O. - ".$row['p3_postoffice'].", Subdiv. - ".$row['p3_subdivision'].", Dist. - ".$row['district'];
			...
			$pa_ofc_address1="P.O. - ".$row['pa_postoffice'].", Subdiv. - ".$row['pa_subdivision'].", Dist. - ".$row['district'];
		   ...
		   $this->SetFont('Arial','B','7');
			...
			$this->Cell($w[3],6,$p1_name,'LR',0,'L',$fill);
			$this->Ln(4);
