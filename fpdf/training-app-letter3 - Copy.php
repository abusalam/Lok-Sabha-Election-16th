  ...
  //  $this->SetTextColor(0);
    ...
    for($i=1;$i<=rowCount($data);$i++)
	{
		...
		if($count<$per_page)
	    {
			...
			$euname1="ORDER OF APPOINTMENT OF PRO & PO FOR TRAINING";
			...
			$nb91="contacted at the following Mobile Nos. 9476228227, 9474543105, 9832735755, 9903761316, 9748543555.";
			...
			$this->Cell(35);
			$this->Cell(92,4,"Name of Polling Officer",0,0,'C');
			$this->SetFont('Arial','B',8);
			$this->Cell(13);
			$this->SetFont('Arial','B',10);
			$this->Cell(33,6,"",0,0,'R');
		...
		//	$this->SetTextColor(0,0,0);
			...
			$odetails="                                OFFICE CODE - (".$row['10'].")                                 ".$row['12'];
		    $this->SetFont('Arial','B',9);
			$this->Cell($w[0],6,$name,1,0,'L',$fill);
			$this->Ln();
			$this->SetFont('Arial','',8);
			...
			$this->Cell($w[0],9,$odetails,'LRB',0,'L',$fill);
			$this->Ln(8);
