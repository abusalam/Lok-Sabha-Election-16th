...
function assembly_change(str)
{
	...
	xmlhttp.open("GET","ajax-master.php?asm="+str+"&sub_div="+subdivision+"&opn=asmember",true);
	xmlhttp.send();
}
function member_change(str)
{
	...
	xmlhttp.onreadystatechange=function()
	  ...
	  if (xmlhttp.readyState==4 && xmlhttp.status==200)
		{
		document.getElementById("party_result").innerHTML=xmlhttp.responseText;
		}
	  }
	  
	xmlhttp.open("GET","ajax-master.php?asm="+assembly+"&nomember="+str+"&sub_div="+subdivision+"&opn=asmnoparty",true);
	xmlhttp.send();
}
function validate()
{
	...
	var rc_address=document.getElementById("rc_address");
	...
	{
		document.getElementById("msg").innerHTML="Select no of member";
		member.focus();
		return false;
	}
	...
	if(rc_address.value=="")
	{
		document.getElementById("msg").innerHTML="Enter RC address";
		rc_venue.focus();
		return false;
	}
}
function dc_venue_change(str)
{
	if($.trim(str)!="")
	{
		var rc_venue=document.getElementById("rc_venue");
...
function dc_address_change(str)
{
	if($.trim(str)!="")
	{
		var rc_address=document.getElementById("rc_address");
		rc_address.value=str;
	}
	else
	{
		var rc_address=document.getElementById("rc_address");
...
<tr><td align="center"><form method="post" name="form1" id="form1" autocomplete="off">
<table width="70%" class="form" cellpadding="0">
    ...
    <tr>
      ...
      <td align="left"><input type='text' name="dc_venue" id="dc_venue" maxlength="45" style="width:192px;" onkeyup="dc_venue_change(this.value)"/></td>
    </tr>
    <tr>
      <td align="left"><span class="error">*</span>DC Address</td>
      <td align="left"><input type='text' name="dc_address" id="dc_address" maxlength="45" style="width:192px;"  onkeyup="dc_address_change(this.value)"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left"><span class="error">*</span>RC Address</td>
      <td align="left"><input type='text' name="rc_address" id="rc_address" maxlength="45" style="width:192px;" /></td>
    </tr>
    <tr><td colspan="2"><img src="images/blank.gif" alt="" height="2px" /></td></tr>
    <tr>
