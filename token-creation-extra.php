...
if(isset($_REQUEST['token_create']) && $_REQUEST['token_create']!=null)
	...
	$sub="";
if($sub=="Token Create for Extra PP")
{
...
function randomise_click()
{
	...
	xmlhttp.open("GET","run.php?subdiv="+sub_div+"&opn=phase",true);
...
<tr>
  <td align="center">TOKEN CREATION FOR EXTRA PP</td></tr>
...
<table width="50%" class="form" cellpadding="0">
    ...
    <tr><td align="center" colspan="2"><img src="images/blank.gif" alt="" height="1px" /></td></tr>
	<tr>
	  <td align="center" colspan="2"><input type="submit" name="token_create" id="token_create" value="Token Create for Extra PP" class="button"  style="height:100px; width:250px;" /></td></tr>
    <tr>
      <td align="left">&nbsp;</td>
      <td align="left">&nbsp;</td>
    </tr>
