...
{
	location.replace("training-venue2.php?venue_cd="+str);
}
...
function delete_trainingvenue(str)
{
	...
	xmlhttp.open("GET","ajax-trainingvenue2-list.php?delcode="+delcode+"&subdivision="+subdivision+"&venuename="+venuename+"&p="+page+"&a="+all,true);
	xmlhttp.send();
	}
}
</script>
