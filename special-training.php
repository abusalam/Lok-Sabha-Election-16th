...
<tr>
  <td align="center">SPECIAL TRAINING ALLOCATION</td></tr>
...
<table width="70%" class="form" cellpadding="0">
    ...
    <tr>
      ...
      <td align="left"><input type="text" name="no_pp" id="no_pp" maxlength="10" style="width:212px;" onkeypress="javascript:return wholenumbersonly(event);"/>&nbsp;&nbsp;&nbsp;
